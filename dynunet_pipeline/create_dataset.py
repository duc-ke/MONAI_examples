...
def get_data_ke(fold, task_id, root_dir, datalist_path, pos_sample_num, neg_sample_num, num_samples, multi_gpu, val_num_workers, 
                cache_rate, train_num_workers, batch_size=1, mode="train"):
    # get necessary parameters:
    fold = fold
    task_id = task_id
    root_dir = root_dir
    ...
    dataset_path = os.path.join(root_dir, task_name[task_id])
    transform_params = (pos_sample_num, neg_sample_num, num_samples)
